...
- **저장 위치:** `02_LITERATURE/024_Gabrielson-Textbook/` 또는 `03_PROJECTS/032_Dissertation/Session-05/`
- **파일명:** `2026-05-04_Session05_Crucible-Report-v1_논문연구리뷰.md`
- **태그:** `#P1_Action #P3_Audit #pharmacometrics/2-compartment #pharmacometrics/reparameterization #regulatory/popPK #nonmem/debugging`
- **링크 제안:** 
  - `[[2026-05-04_Session05_Audit-Report-v1]]`
  - `[[2026-05-04_Session05_Step1-Draft-v0]]`
  - `[[NONMEM Condition Number Threshold]]`
  - `[[Vss vs Vbeta Distinction]]`
