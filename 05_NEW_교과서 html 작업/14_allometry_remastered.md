...
### 2-2. 0.75와 1의 차이가 임상에서 얼마나 큰지 — 다시 한번 자릿수 감각
...
여기서 진짜 실무 함정이 나옴. G&W Fig.2.159는 91개 화합물 CL 지수를 다 그려봤더니 **0.5~1.0 범위에 흩어져 있음** [G&W p.191]. 즉 0.75는 **prior**일 뿐 자연상수가 아님. 
...
이름이 **Kallynochron** ("kg당 생리학적 시간"). K는 kg로 외움.
...
### Pair 4. [보강본_final] mg/kg vs mg/1.73 m² vs BW^0.75
...
### Pair 5. [보강본_final] 임신부 Total vs Unbound
...
13. **[보강본_final] 임신부 phenytoin** — Total 5 mg/L (정상범위 하한 미달) 시 (i) dose 증량? (ii) fetus 노출? (iii) 분만 직후?
