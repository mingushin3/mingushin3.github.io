...
- **수송체(Transporter)**: 수동 촉진 수송체(passive facilitated transporter)는 평형 도달 속도를 바꾸고, 능동 수송체(active transporter)는 정상상태 유리 농도비(steady-state unbound ratio) 자체를 바꿀 수 있습니다. 능동 수송이 있을 때는 다음과 같습니다.
