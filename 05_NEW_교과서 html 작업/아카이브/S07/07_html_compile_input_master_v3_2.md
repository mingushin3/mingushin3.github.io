# 07_html_compile_input_master_v3.2.md
...
**Type 라벨 정의** (ver2 신설 — ver1의 미정의 J/F/M/K/R/W 문자 교체):

- **Practice Lens** — 숙련자의 점검 순서/판단 frame을 제공하는 노트.
- **Failure Mode** — 학습자가 빠지기 쉬운 구체적 오류 시나리오.
- **Mastery Note** — 개념을 더 깊은 구조로 다시 보게 만드는 통찰.

본문 §2 카드의 callout 라벨(`Practice Lens` / `Failure Mode` / `Mastery Note`)과 동일하게 사용된다.
