...
# 15_HTML Compile Input Master — v3.1

**Target file**: `15_html_compile_input_master_v3.1.md`  
**Assembly date**: 2026-05-07 (v3.1 Korean Readability Patch date; v3 surgical patch base preserved)  
**Assembly mode**: PATCH MODE  
**Phase**: 4E + v3 Surgical Patch + v3.1 Korean Readability Patch
...
*`15_html_compile_input_master_v3.1.md` — Independent Pharmacometrics Master Reviewer & Korean Readability Patch Editor, 2026-05-07*  
