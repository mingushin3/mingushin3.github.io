# 세션 04 — 청소율(Clearance): 신·간·IVIVE·대사체 — $CL_R$, $CL_H$, well-stirred, parent-metabolite — v4.0 보강본

> **본 보강본의 변경 요약 (보존 vs 신규)**
> - **완전 보존**: §1, §1.5, M1, M3, M5–M10, M11–M14, §5 혼동 쌍, §7 Q1–Q8, §8 (단, §8G만 신규 추가)
> - **부분 보강**: M2 (1차 재흡수 가정 한계 + 신장 transporter 임상 anchor 추가), M4 (CYP 분포·다형성·염증 항 추가), Q9 (무뇨 시 $f_m$ 변화 산출 단계 명시화)
> - **신규 카드 추가**: M2.5 (eGFR 추정식 + 담즙 청소율 + 장간순환), M10.5 (Phase II 대사: UGT/SULT)
> - **신규 섹션 추가**: §8G (Allometric scaling — NONMEM 체중 covariate 출발점)
...
<!-- v4.0 보강본 변환 노트
- 원본 v4.0 대비 변경 요약:
  · §1, §1.5, M1, M3, M5–M10, M11–M14, §5 혼동 쌍 1–10, §7 Q1–Q8, §8A–§8F: 완전 보존
  · M2: F_R 1차 재흡수 가정 한계 + methamphetamine/phenobarbital 표 + 신장 transporter DDI 표 추가
    - 출처: R&T pp.142–148 (Fig 5-16, 5-18), R&T 분포 챕터 Fig 4-8 p.86
  · M2.5 (신규): eGFR 추정식 (CG/MDRD/CKD-EPI) + 담즙 청소율 + 장간순환
    - 출처: R&T pp.137–138 (Eq 5-16, Fig 5-12)
  · M4 B1–B3 (신규): CYP 효소 분포 + CYP2D6 다형성 정량 + 염증성 CYP downregulation
    - 출처: R&T pp.121–123 (Figs 5-2, 5-3), R&T pp.549–559 (Fig 17-15, Eq 17-18, Table 17-6)
  · M6: G&W Table 2.8 MMP 보정 함정 정량 anchor 추가 (low → intermediate → high extraction 분류 전환)
  · M10.5 (신규): Phase II 대사 (UGT/SULT) — Irinotecan/UGT1A1*28, Lamotrigine/Valproate, MMF/MPA, Morphine/M6G
    - 출처: R&T pp.121–122
  · Q9: f_m 0.3 → 0.6 자동 증가 산출 단계 5단계 명시화 (Step 1–5)
  · §8G (신규): Allometric scaling (CL ∝ BW^0.75, V ∝ BW^1.0) + Anderson-Holford maturation + 비만 체중 + NONMEM 코드 예시
    - 출처: G&W p.87 Table 2.7, §2.10 interspecies scaling
- 수식 보강 원칙 준수: 새 수식은 모두 overbrace/underbrace annotation 적용 ✓
- 출처 표기 일관성: G&W (Gabrielsson & Weiner) / R&T (Rowland & Tozer) 페이지·식 번호 정확 기재 ✓
- 원본 보존: §5 혼동쌍 10개, §7 Q1–Q8, §8A–§8F 완전 보존 ✓
- 보존된 모든 정량 anchor: 250 mg IV, V≈7L/CL≈1.2 L/h/f_e≈35%, CV 2.84%/8.96%, 6–6.3h, methamphetamine 70-80%/1-2%, phenobarbital pH dependence, ritonavir 0.94→0.32 L/h/kg, propranolol 20 mg, morphine 11.7/5 mg, M14: 0.27+0.24=0.51 mg/L, 2배/13배/0.14, Q4: 20→80 E=0.20→0.50, Q5: 60/0.5/30/0.37, Q2: 10/0.6→1.5/4/5.5 L/h, hook 60 L/h/0.5/30/0.37
- 새로 추가된 정량 anchor: Q_H 1.35 L/min = 81 L/h (기존 보존), CYP2D6 PM 4배 AUC 변화, f_m,POLY=0.75에서 10배 이상 PM 증폭, UGT1A1*28 동형접합체 ~10% Caucasian, lamotrigine t1/2 25h → 50h (UGT2B7 억제), liver weight 종간 표 (Human 1500g / Dog 320g / Rat 10g 등), maturation TM50: UGT2B7 36주/CYP3A4 45주
-->

---

**문서 ID**: C-260517-082345-K7P
