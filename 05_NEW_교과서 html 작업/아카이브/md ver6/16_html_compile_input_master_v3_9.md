# 세션 16 — 임상 통합 캡스톤: 패턴 인식 · TDM · 질환 · 치료 의사결정 — v3.9
...
- **Gabrielsson & Weiner 5e**: Ch.6 Pattern Recognition [G&W pp.423–466], PK15 Toxicokinetics [G&W pp.546–548], PK35 Bayesian model — Digoxin [G&W pp.641–643]
- **Rowland & Tozer 5e**: Ch.15 Disease [R&T pp.443–489], Ch.18 Initiating and Managing Therapy [R&T pp.577–610]
...
> 📖 **G&W Ch.6 Fig.6.1 [G&W p.423], Fig.6.12 [G&W pp.465–466]**: Fig.6.1은 baseline·delay·peak-shift·saturation·slope라는 초기 시각 문법을 보여주고, Fig.6.12는 그 문법을 실제 분석 workflow로 바꿉니다.
...
> 📖 **G&W Ch.6 Fig.6.2 [G&W p.424], Fig.6.3 [G&W p.428]**: Fig.6.2는 반응-시간 움직임이 좌측 또는 우측으로 이동하는 모습을, Fig.6.3은 competing alternatives를 함께 보여주어 하나의 pattern을 하나의 model에 바로 대응시키는 오류를 막아 줍니다.
...
> 📖 **G&W PK35 Fig.35.1 [G&W pp.641–642]; R&T Ch.18 Fig.18-13 [R&T pp.605–606]**: Fig.35.1은 환자별 청소율 변동성이 농도-시간 거동과 어떻게 연결되는지를, Fig.18-13은 채혈 시점에 따라 $V$ vs $CL$ 추정 신뢰도가 왜 달라지는지를 보여 줍니다.
...
> 📖 **R&T Ch.15 Fig.15-18 [R&T p.471], Fig.15-19 [R&T p.473]**: Fig.15-18은 투석 제거가 hard threshold가 아니라 $V_u$와 $CL_u$의 연속 함수임을, Fig.15-19는 투석 중 제거량을 보충 용량 개념과 연결합니다.
...
> 📖 **R&T Ch.18 Fig.18-5 [R&T p.582]**: 이 그림은 $V/CL$ 예측 정확도를 잘못 읽는 오류를 바로잡는 데 핵심입니다. 용량 정확도(dosing precision)를 약속하는 그림이 아니라 변동성 분할(variability partition)입니다.
