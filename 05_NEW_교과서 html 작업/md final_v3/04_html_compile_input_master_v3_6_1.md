...
<!-- SECTION_CORE: SC-01 -->
> 🎯 **[지금 이 슬라이드들이 존재하는 이유]** $CL$은 단일 숫자가 아니라 농도 기준·장기·투여 경로·분석대상을 함께 찍어야 열리는 제거 지도다.
...
<!-- SECTION_CORE: SC-02 -->
> 🎯 **[지금 이 슬라이드들이 존재하는 이유]** $CL$과 $V$를 먼저 분해하라 — $t_{1/2}$와 $AUC$는 원인이 아니라 그 둘이 남긴 관찰 흔적이다.
...
<!-- SECTION_CORE: SC-03 -->
> 🎯 **[지금 이 슬라이드들이 존재하는 이유]** $CL_R$은 total $CL$의 축소판이 아니라 소변량·AUC·$f_e$·여과/분비/재흡수를 잇는 측정 교량이다.
...
<!-- SECTION_CORE: SC-04 -->
> 🎯 **[지금 이 슬라이드들이 존재하는 이유]** ARE plot과 excretion-rate plot은 같은 $K$를 보지만, 시간 배치와 소변 수집 잡음에 서로 다른 약점을 드러낸다.
...
<!-- SECTION_CORE: SC-05 -->
> 🎯 **[지금 이 슬라이드들이 존재하는 이유]** $CL_H$는 $Q_H$와 $f_{ub}CL_{int}$의 경쟁이다 — extraction class와 route를 분리하지 않으면 단백결합 해석이 뒤집힌다.
...
<!-- SECTION_CORE: SC-06 -->
> 🎯 **[지금 이 슬라이드들이 존재하는 이유]** IVIVE와 PK5는 식보다 데이터 압축이 먼저다 — $CL_{int}$, plasma, urine이 무엇을 잃고 들어왔는지 먼저 봐라.
...
<!-- SECTION_CORE: SC-07 -->
> 🎯 **[지금 이 슬라이드들이 존재하는 이유]** Plasma $CL$을 blood $CL_b$로 바꾸지 않으면 $Q_H$와 같은 생리학 단위에서 organ extraction을 판단할 수 없다.
...
<!-- SECTION_CORE: SC-09 -->
> 🎯 **[지금 이 슬라이드들이 존재하는 이유]** 대사체 terminal slope와 $AUC(m)/AUC$는 $f_m$ 하나로 읽지 말고 formation과 $CL(m)$ 중 어느 축이 병목인지 분리하라.
...
<!-- SECTION_CORE: SC-10 -->
> 🎯 **[지금 이 슬라이드들이 존재하는 이유]** 정상상태와 신장애에서는 작은 $f_m$도 $CL(m)$ 붕괴와 active metabolite 축적으로 전체 위험을 지배할 수 있다.
...
<!-- SECTION_CORE: SC-11 -->
> 🎯 **[지금 이 슬라이드들이 존재하는 이유]** $CL$, $CL_R$, $f_e$, $CL_b$, $f_u$, route를 섞는 순간 covariate와 extraction 판단은 단위부터 틀어진다.
...
<!-- SECTION_CORE: SC-12 -->
> 🎯 **[지금 이 슬라이드들이 존재하는 이유]** Well-stirred, single-point $CL_{int}$, metabolite rate-limit, interconversion의 혼동은 parent–metabolite joint model의 구조를 무너뜨린다.
...
<!-- SECTION_CORE: SC-13 -->
> 🎯 **[지금 이 슬라이드들이 존재하는 이유]** Self-Test의 목적은 계산 정답이 아니라 $CL$, $V$, $Q_H$, $f_u$, $CL(m)$을 어느 자리에 놓아야 하는지 검증하는 것이다.
...
<!-- SECTION_CORE: SC-14 -->
> 🎯 **[지금 이 슬라이드들이 존재하는 이유]** 후반 Self-Test는 plasma/blood 기준, IVIVE 압축, 대사체 율속, renal impairment active metabolite 방어논리를 한 번에 묶는다.
...
<!-- SECTION_CORE: SC-15 -->
> 🎯 **[지금 이 슬라이드들이 존재하는 이유]** 최종 교량은 교과서 식의 각 항을 NONMEM covariate 자리, endpoint 선택, label 방어논리로 정확히 번역하는 일이다.
