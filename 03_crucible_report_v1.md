...
## 📁 Obsidian Filing Metadata

**저장 위치:** `02_LITERATURE/024_Gabrielson-Textbook/S03_Oral_PK/03_Crucible_Report_v1.md`
**연결 위치 (cross-link):** `03_PROJECTS/032_Dissertation/Pharmacometrics_Curriculum/S03/`

**파일명:** `2026-05-03_Session03_Crucible_Report_v1_논문리뷰.md`

**Tags:**
- `#P1_Action` (Phase 4A 패치 instruction)
- `#P3_Audit` (regulatory risk surface)
- `#pharmacometrics/oral-pk`
- `#identifiability/structural-vs-numerical`
- `#NONMEM/diagnostic-signatures`
- `#flip-flop`
- `#V-over-F`
- `#bioavailability-F`
- `#crucible-phase`
...
- `[[S03_Audit_Report_v1]]`
- `[[S03_Patch_Memo]]`
- `[[Master_Equation_Eq2-35]]`
- `[[V_over_F_Identifiability]]`
- `[[Flip-flop_Phenomenon]]`
- `[[NONMEM_ADVAN2_Coding_Standards]]`
- `[[Phase_4A_Integration_Compression]]` (다음 단계)

**관련 노트 (existing):**
- `[[Phantom_Volume_Drift_GOF_Signature]]` (본 세션에서 명명 확장)
- `[[Twin_Suppression_Pattern]]` (신규 명명, 별도 atom 작성)
- `[[V_over_F_Drift_Covariate_Signature]]` (신규 명명, 별도 atom 작성)
